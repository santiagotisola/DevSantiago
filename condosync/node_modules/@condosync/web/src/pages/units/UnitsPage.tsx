...
export function UnitsPage() {
  ...
  const filtered = ((units || []) as any[]).filter(
    (u: any) =>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Mapa e gerenciamento de unidades
          </p>
        </div>
        {isAdmin && (
          <button
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {filtered.map((u: any) => {
            ...
            return (
              <div
                key={u.id}
                className="bg-white border rounded-xl p-3 text-center hover:shadow-md transition-shadow space-y-1"
              >
                ...
                <div
                  className={`mt-2 text-xs px-2 py-0.5 rounded-full font-medium inline-block ${st.className}`}
                >
                  {st.label}
                </div>
                {u.resident && (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1 col-span-2">
                ...
                <input
                  ...
                  placeholder="Ex: Casa 01, Lote 15"
              ...
              <div className="space-y-1 col-span-2">
                ...
                <input
                  ...
                  placeholder="Ex: Rua das Palmeiras, 500"
                  className="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
          ...
          <div className="bg-white rounded-xl w-full max-w-md p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium">Fração ideal (%)</label>
                <input
                  value={editForm.fraction}
                  onChange={(e) =>
                    setEditForm({ ...editForm, fraction: e.target.value })
                  }
                  placeholder="Ex: 0.10"
                  type="number"
                  step="0.01"
