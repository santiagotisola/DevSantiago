...
router.patch("/:id", (0, auth_1.authorize)("DOORMAN", "CONDOMINIUM_ADMIN", "SYNDIC", "SUPER_ADMIN"), visitor_controller_1.visitorController.update.bind(visitor_controller_1.visitorController));
router.patch("/:id/authorize", (0, auth_1.authorize)("RESIDENT", "DOORMAN", "CONDOMINIUM_ADMIN", "SYNDIC", "SUPER_ADMIN"), visitor_controller_1.visitorController.authorize.bind(visitor_controller_1.visitorController));
router.get("/unit/:unitId/history", (0, auth_1.authorize)("RESIDENT", "DOORMAN", "CONDOMINIUM_ADMIN", "SYNDIC", "SUPER_ADMIN"), visitor_controller_1.visitorController.historyByUnit.bind(visitor_controller_1.visitorController));
