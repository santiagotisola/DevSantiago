...
router.get(
  ...
  authorizeCondominium,
  visitorController.list.bind(visitorController),
);
...
router.post(
  ...
  visitorController.registerEntry.bind(visitorController),
);
router.post(
  "/:id/exit",
  authorize("DOORMAN", "CONDOMINIUM_ADMIN", "SYNDIC", "SUPER_ADMIN"),
  visitorController.registerExit.bind(visitorController),
);
router.patch(
  "/:id",
  authorize("DOORMAN", "CONDOMINIUM_ADMIN", "SYNDIC", "SUPER_ADMIN"),
