...
router.post('/reservations', async (req: Request, res: Response) => {
  ...
  const area = await prisma.commonArea.findUniqueOrThrow({ where: { id: data.commonAreaId } });
...
router.patch('/reservations/:id/approve', authorize('CONDOMINIUM_ADMIN', 'SYNDIC', 'SUPER_ADMIN'), async (req: Request, res: Response) => {
...
router.get('/reservations/condominium/:condominiumId', async (req: Request, res: Response) => {
  const reservations = await prisma.reservation.findMany({
    where: {
