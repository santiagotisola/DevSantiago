...
export function ReportsPage() {
  ...
  const downloadPdf = async () => {
    try {
      ...
      const response = await api.get(`/reports/financial/${selectedCondominiumId}/pdf`, {
        params: { referenceMonth: month },
        responseType: 'blob'
      });
      ...
      link.href = url;
      link.setAttribute('download', `prestacao-contas-${month}.pdf`);
