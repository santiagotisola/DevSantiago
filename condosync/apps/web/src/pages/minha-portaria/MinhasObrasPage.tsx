...
export default function MinhasObrasPage() {
  ...
  const updateStatusMutation = useMutation({
    mutationFn: ({ id, status }: { id: string; status: string }) =>
      api.patch(`/renovations/${id}/status`, { status }),
    onSuccess: () => qc.invalidateQueries({ queryKey: ["renovations-unit"] }),
  });
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Solicite autorização e gerencie os prestadores da sua unidade
          </p>
        </div>
        <button
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    value={(providerForm as Record<string, string>)[key]}
                    onChange={(e) =>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-4 mt-2 text-xs text-gray-400">
                    ...
                    {r.endDate && (
                      <span>
                        Fim: {new Date(r.endDate).toLocaleDateString("pt-BR")}
                      </span>
                    )}
                    <span>
                      Criada em:{" "}
