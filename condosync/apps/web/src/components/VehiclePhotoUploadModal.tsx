...
import { useUploadVehiclePhoto, useDeleteVehiclePhoto, normalizePhotoPath } from '../hooks/useImageUpload';
import { Loader2, AlertCircle } from 'lucide-react';

interface VehiclePhotoUploadModalProps {
  vehicleId: string;
...
export function VehiclePhotoUploadModal({
  vehicleId,
  currentPhotoPath,
  onSuccess,
  onClose,
}: VehiclePhotoUploadModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl w-full max-w-md p-6 space-y-4">
        <h2 className="text-lg font-semibold">Foto do Veículo</h2>
