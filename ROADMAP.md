...
**Status:** `[x] Concluido - Marco/2026`  
**Descricao:** Morador registra reforma em andamento na sua unidade e lista os prestadores autorizados a entrar. O nucleo de cadastro, aprovacao e o fluxo operacional da portaria estao implementados.  
**O que foi feito:**
...
- Backend portaria: `GET /renovations/unit/:unitId/active-providers` — retorna prestadores de obras APPROVED/IN_PROGRESS; acessivel para DOORMAN/CONDOMINIUM_ADMIN/SYNDIC/SUPER_ADMIN
...
- Frontend portaria: `VisitorsPage` — ao clicar "Entrada", abre modal de confirmacao que consulta obras ativas da unidade e lista prestadores autorizados para verificacao visual pelo porteiro; ao registrar novo visitante, exibe painel informativo de prestadores autorizados quando a unidade tem obras ativas
- Menu "Minhas Obras" adicionado em "Minha Portaria" (RESIDENT); menu "Obras" adicionado para CONDOMINIUM_ADMIN/SYNDIC/SUPER_ADMIN

**Esforco estimado:** Medio (novo modelo `Renovation` + portal morador + fluxo administrativo + portaria)
